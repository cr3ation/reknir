...
import { X, AlertTriangle, CheckCircle, XCircle, Upload, Server, Loader2 } from 'lucide-react'
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-gray-600 mt-1">
                          <span>Skapad: {formatDate(backup.created_at)}</span>
                          <span>Storlek: {formatFileSize(backup.size_bytes)}</span>
                          <span>Schema: {backup.schema_version}</span>
                        </div>
                      </div>
                    </label>
                  ))}
