...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_account_company_fiscal_year_number", "accounts", ["company_id", "fiscal_year_id", "account_number"]
    )
    ...
    op.alter_column("verifications", "fiscal_year_id", existing_type=sa.INTEGER(), nullable=False)


def downgrade() -> None:
    # Revert fiscal_year_id to nullable
    op.alter_column("verifications", "fiscal_year_id", existing_type=sa.INTEGER(), nullable=True)
