...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('account_type', sa.Enum(
            'asset', 'equity_liability', 'revenue', 'cost_goods', 'cost_local',
            'cost_other', 'cost_personnel', 'cost_misc', name='accounttype'
        ), nullable=False),
    ...
    op.create_index(op.f('ix_verifications_verification_number'), 'verifications', ['verification_number'], unique=False)
